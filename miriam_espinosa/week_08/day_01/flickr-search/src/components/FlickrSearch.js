  ...
  render () {
    return (
      <form onSubmit={this._handleSubmit}>
        ...
        <input type="submit" value="Search"/> {/* value search is to display a word in the button */}
      </form>
    );
  }
}
...
//   render() {
//     return (
//       <img src={this.props.url} width="150" height="150" alt={this.props.url}/>
//     );
//   }
// }

//functional Component (if you dont need state or callbacks)
...
function FlickrSearchGallery(props) {
  return (
    <div>
      { props.images.map( (imageURL) => <FlickrSearchImage  url={imageURL} key={imageURL} />)
      }
    </div>
  )
}
...
class FlickrSearch extends Component {
  ...
  fetchImages(q) {
    ...
    //if you werent using JSONP, use AXIOS for your AJAX.
